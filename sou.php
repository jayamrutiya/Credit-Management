...
<div class="container">
	<form action="sou.php" method="post">
	<div class="row">
		
	<?php  

		$query = "SELECT name,email FROM userdata";
	...
	<div class="col-3 my-5">
        <input type="submit" name="user" class="btn btn-secondary" value="<?php echo $name; ?>">	
	</div>
    <?php
    	}
    ?>
...
if (isset($_POST['user'])) {
	$name= $_POST['user'];
	$qu = "SELECT id,name,email,phone_no,current_credit FROM userdata WHERE name='$name'";
